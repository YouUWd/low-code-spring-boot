...
/** 审批链配置详情响应 */
@Data
@Schema(description = "单据审批链配置信息")
public class ModuleApprovalChainConfigResp {
    @Schema(description = "审批链配置列表")
    private List<ApprovalChainConfigDetail> approvalChainConfigList;

    @Schema(description = "状态列表")
    private List<StatusNode> statusList;

    @Schema(description = "按钮配置列表")
    private List<ButtonConfigDetail> buttonList;

    /** 按钮配置详情 */
    @Data
    @Schema(description = "按钮配置详情")
    public static class ApprovalChainConfigDetail {
        ...
        private String approverWorkNumber;
    ...
    @Data
    @Schema(description = "按钮配置详情")
    public static class ButtonConfigDetail {
