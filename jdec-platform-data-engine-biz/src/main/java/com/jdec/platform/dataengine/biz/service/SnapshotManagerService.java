...
import com.jdec.platform.dataengine.biz.snapshot.SnapshotDiffEngine;
...
public class SnapshotManagerService implements DataSnapshotApi {
    ...
    public Long triggerSnapshot(DynamicSnapshotTriggerReq req) {
        ...
        DynamicDetailResp detailResp = dynamicQueryService.getDetail(moduleId, dataId);
        String currentSnapshotJson = JSON.toJSONString(detailResp);
